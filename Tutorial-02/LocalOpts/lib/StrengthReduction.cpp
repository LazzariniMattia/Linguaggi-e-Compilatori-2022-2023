...
// opt-14 -load-pass-plugin=./libLocalOpts.so -passes=strengthreduction test/test.ll -o test/test.strengthreduction.optimized.bc
// llvm-dis-14 test/test.strengthreduction.optimized.bc -o test/test.strengthreduction.optimized.ll
